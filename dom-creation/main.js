...
function renderPokemon(pokemon) {
  ...
  $newDivOne.setAttribute('class', 'column-third');

  var $newDivTwo = document.createElement('div');
  $newDivTwo.setAttribute('class', 'pokemon-card');
  ...
  $newDivThree.setAttribute('class', 'pokemon-card-text');
  $newDivTwo.appendChild($newDivThree);

  var $newHTwo = document.createElement('h2');
  var $newTextOne = document.createTextNode(pokemon.name);
  $newHTwo.appendChild($newTextOne);
  $newDivThree.appendChild($newHTwo);

  var $newHThree = document.createElement('h3');
  var $newTextTwo = document.createTextNode('#' + pokemon.number);
  $newHThree.appendChild($newTextTwo);
